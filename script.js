        ...
        async function verificarProyectoJaEstado(username) {
            try {
                const response = await fetch(`https://api.picarto.tv/api/v1/channel/name/${username}`);
        ...
        function mostrarMensajeDelDia(mensajes, dia) {
            ...
            if (mensajeDelDia) {
                ...
                fechaHoraElem.textContent = `${fechaAux || 'Fecha desconocida'} - ${mensajeDelDia.hora || 'Hora desconocida'}`;
                ...
                if (mensajeDelDia.redes_sociales && mensajeDelDia.redes_sociales.whatsapp) {
                    ...
                    whatsappBtn.onclick = () => window.open(mensajeDelDia.redes_sociales.whatsapp, '_blank');
                ...
                if (mensajeDelDia.redes_sociales && mensajeDelDia.redes_sociales.facebook) {
                    ...
                    facebookBtn.onclick = () => window.open(mensajeDelDia.redes_sociales.facebook, '_blank');
                    redesSocialesElem.appendChild(facebookBtn);
                }

                if (mensajeDelDia.redes_sociales && mensajeDelDia.redes_sociales.instagram) {
                    const instagramBtn = document.createElement('button');
                    instagramBtn.className = 'instagram';
                    instagramBtn.textContent = 'Instagram';
                    instagramBtn.onclick = () => window.open(mensajeDelDia.redes_sociales.instagram, '_blank');
                ...
                if (mensajeDelDia.redes_sociales && mensajeDelDia.redes_sociales.youtube) {
                    ...
                    youtubeBtn.onclick = () => window.open(mensajeDelDia.redes_sociales.youtube, '_blank');
                ...
                if (mensajeDelDia.redes_sociales && mensajeDelDia.redes_sociales.tiktok) {
                    ...
                    tiktokBtn.onclick = () => window.open(mensajeDelDia.redes_sociales.tiktok, '_blank');
                ...
                if (mensajeDelDia.publicador === "PROYECTO JA" && proyectoJaOnline) {
                    ...
                    perfilElem.onclick = () => {
                        window.open('https://proyectoja.github.io/embedClappr.html?video=https://edge1-us-miami.picarto.tv/stream/hls/golive%2bXSTUDIOCODE/0_1/index.m3u8&poster=https://i.imgur.com/ayIV94z.jpg', '_blank');
                    };
                ...
                <h3 style="color:white; font-family: Arial, Helvetica, sans-serif;">${mensajeDelDia.publicador}</h3>
                <p style="color:white; font-family: Arial, Helvetica, sans-serif;">
                    Estado: ${mensajeDelDia.publicador === "PROYECTO JA" && proyectoJaOnline ? '<span style="color:red;">EN VIVO 🔴</span>' : 'Fuera de línea'}
                </p>
                `;
                ...
                document.getElementById("mensajeContainer").innerHTML = "<p>No hay mensaje para hoy.</p>";
            }
        }

        // Cargar el archivo JSON y mostrar el mensaje correspondiente al día actual
        // URL del archivo JSON
        const jsonUrlPROYECTOJA = "https://proyectoja.github.io/proyecto_ja_001_365.json";
        const jsonUrlELLENWHITE = "https://proyectoja.github.io/ellen_g_white_001_365.json";
        const jsonUrlDios = "https://proyectoja.github.io/Dios_001_365.json";
        const jsonUrlPsicologiaPositiva = "https://proyectoja.github.io/psicologia_positiva_001_365.json";
        ...
        verificarProyectoJaEstado(username)
            .then(
                function () {
        ...
        function descargarImagen(elemento) {
            ...
            html2canvas(copiaElem, { backgroundColor: "#080c1c", scale: 3, useCORS: true }).then(canvas => {
        ...
        function toggle(){
            ...
            const barraCentralContenido = document.getElementById('barraCentralContenido');
