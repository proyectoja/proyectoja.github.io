(function (a, k) {
  ...
  a.fn.kasradio = function (g) {
    ...
    e
      ...
      : this.each(function () {
          a(this).data("kasradio", new a.kasradio(this, g));
        });
    return I;
  };
  a.kasradio = function (g, e) {
    ...
    a(document).ready(function () {
      ...
      var a = document.getElementsByTagName("script"),
        ...
        l;
      for (c = 0; (l = a[c]); c++)
        if (((l = l.src), 0 <= l.indexOf("nativekasradiov4.js")))
          var d = l.substring(0, l.indexOf("nativekasradiov4.js"));
      ta = d;
